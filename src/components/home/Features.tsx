...
const features = [
  {
    ...
    description:
      "Chaque notion est suivie d'un exercice ou d'une application concrète. On apprend en faisant, pas en lisant.",
  ...
  },
  {
    ...
    description:
      'Les apprenants travaillent sur des cas réalistes pour mieux comprendre le terrain et construire des réalisations présentables.',
  ...
  },
  {
    ...
    description:
      'Cours gratuits, supports PDF, vidéos ou contenus structurés selon les modules — disponibles à votre rythme.',
  ...
  },
  {
    ...
    description:
      "Remise aux apprenants ayant suivi et validé leur parcours. Une preuve concrète de votre engagement.",
  ...
  },
  {
    ...
    description:
      "Les parcours sont organisés étape par étape pour faciliter l'apprentissage et éviter de se perdre.",
  ...
  },
  {
    ...
    description:
      'Aide à mieux comprendre les métiers du digital et choisir une spécialisation adaptée à votre profil.',
